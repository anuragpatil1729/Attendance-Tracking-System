...
public class AttendanceHistoryPanel extends JPanel {
    ...
    public void setRecords(List<AttendanceRecord> records) {
        ...
        for (AttendanceRecord r : records) {
            model.addRow(new Object[]{r.getSessionId(), r.getStatus(), r.getMarkedAt() == null ? "-" : r.getMarkedAt().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm")), r.getSyncStatus()});
        }
    }
    ...
    private static class HistoryRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            if (!isSelected) c.setBackground(row % 2 == 0 ? Constants.INPUT : Constants.SIDEBAR);
